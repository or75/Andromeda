...
auto CGameTrace::DidHitWorld() const -> bool
{
	return ( m_pEnt == source::m_client_entity_list->GetClientEntity( 0 ) );
}

auto CGameTrace::DidHitNonWorldEntity() const -> bool
{
	return ( m_pEnt != nullptr && !DidHitWorld() );
}

auto CGameTrace::GetEntityIndex() const -> int
{
	if ( m_pEnt )
...
#pragma region region_procedure_impl
